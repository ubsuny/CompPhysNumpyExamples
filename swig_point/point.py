...
class Point(_object):
    ...
    def _print(self):
        return _point.Point__print(self)

    def x(self):
        return _point.Point_x(self)

    def y(self):
        return _point.Point_y(self)

    def __add__(self, right):
        return _point.Point___add__(self, right)

    def __sub__(self, right):
        return _point.Point___sub__(self, right)

    def __iadd__(self, right):
        return _point.Point___iadd__(self, right)

    def __isub__(self, right):
        return _point.Point___isub__(self, right)

    def input(self, arg2):
        return _point.Point_input(self, arg2)
